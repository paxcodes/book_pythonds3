...
from a_introduction.b_infinite_monkey_theorem import CHARACTER_SET, GOAL, GOAL_LENGTH
from a_introduction.b_infinite_monkey_theorem import generate as generate_fresh
from a_introduction.b_infinite_monkey_theorem import score

# One way to make chapter1_2 imports to work is to modify PYTHONPATH before
# running the python script:
# bash$ export PYTHONPATH=$PYTHONPATH:/path/to/pythonds3
# bash$ python /path/to/pythonds3/c_infinite_monkey_...
